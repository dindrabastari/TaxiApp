...
public class OrderActivity extends AppCompatActivity{
    ...
    public static final String ORDER_URL = "http://dindrabastari.esy.es/citra/index.php/mobile/get_all_order_driver";
    public static final String ORDER_URL_HISTORY = "http://dindrabastari.esy.es/citra/index.php/mobile/get_history_order_driver";
    ...
    class Order {
        String id_pemesanan, id_pelanggan, lokasi_jemput, lokasi_tujuan, tanggal_pemesanan, status_pemesanan;

        Order(String id_pemesanan, String id_pelanggan, String lokasi_jemput, String lokasi_tujuan, String tanggal_pemesanan, String status_pemesanan) {
    ...
    private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(final View view) {
            ...
            Intent in = getIntent();
            if (in.getStringExtra("EXTRAS").equals("new")) {
    ...
    private void orderLogic(){
        class OrderLogic extends AsyncTask<String,Void,String> {
            ...
            protected String doInBackground(String... params) {
                ...
                String result;
                if (i.getStringExtra("EXTRAS").equals("new")) {
                    result = rh.sendPostRequest(ORDER_URL, data);
                }else{
                    result = rh.sendPostRequest(ORDER_URL_HISTORY, data);
                }
        ...
        try {
            ...
            for(int i=0; i < jsonArray.length(); i++){
                ...
                if (!status.equals("sukses")){
                    ...
                    data = status;
                    orders.add(new Order(id_pemesanan, id_pelanggan, lokasi_jemput, lokasi_tujuan, tanggal_pemesanan, status_pemesanan));
                }
            }
